...
import com.qa.SelfServiceUtilities.WebEventListener;

public class SelfServiceBaseClass {
	...
	public static void initialization() throws IOException {
		...
		String SelfServiceURL = wso.getRow(1).getCell(2).getStringCellValue().trim();
		driver.get(SelfServiceURL);
